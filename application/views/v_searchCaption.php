    ...
    <main id="feed">
        ...
        <div class="photo">
            <header class="photo__header">
                <img src="<?php echo base_url('assets/images/').$foto->profile_photos;?>" class="photo__avatar" />
                <div class="photo__user-info">
                    <span class="photo__author"><?php echo $foto->username;?></span>
                </div>
            </header>
            <center><img class="img-fluid" height="400px" width="400px" src="<?php echo base_url('assets/images/').$foto->url;?>" /></center>
